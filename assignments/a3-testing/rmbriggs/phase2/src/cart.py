...
class Cart:
    ...
    def total_cents(self) -> int:
        ...
        percent_code = next((c for c in self._codes if c in PERCENT_CODES), None)
        ...
        freeship_waives = "FREESHIP" in self._codes and subtotal >= FREESHIP_THRESHOLD
        if not freeship_waives:
